                ...
                <section class="flex flex-col justify-center">
                    ...
                    <div class="mt-8 flex flex-col gap-3 sm:flex-row">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('agro.index')); ?>"
                            ...
                            <div class="border-b border-slate-100 px-6 py-6 sm:px-8">
                                <div class="flex items-center gap-4">
                                    <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-50 p-2 shadow-sm">
                                        <img src="<?php echo e(asset('assets/img/logo-agroseguro.png')); ?>" alt="Agro Seguro Scanner" class="max-h-12 w-auto">
                                    </div>
...
</html><?php /**PATH /home/agroseguro/agroseguro/resources/views/landing.blade.php ENDPATH**/ ?>